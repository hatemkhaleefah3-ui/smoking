...
assert.match(frontend, /image\.src = fallback/);
...
assert.match(worker, /openverse_result_skipped/);
assert.match(worker, /insecure-http-primary-url/);
assert.match(worker, /skippedInvalidPrimary/);
